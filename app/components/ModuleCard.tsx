    ...
    return (
      <article className="overflow-hidden rounded-xl border border-dashed border-white/15 bg-white/5 shadow-none select-none backdrop-blur-lg">
        ...
        <div className="relative h-40 w-full overflow-hidden">
          ...
          <span className="absolute right-3 top-3 rounded-full bg-white/15 px-2.5 py-1 text-xs font-medium text-gray-300 backdrop-blur-sm">
        ...
        <div className="p-4 sm:p-5">
          <h3 className="text-lg font-semibold text-gray-300 leading-snug">
          ...
          <span className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-white/5 px-4 py-2.5 text-sm font-medium text-gray-400 cursor-not-allowed border border-white/10">
