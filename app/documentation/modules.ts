...
const modulesData: DocumentationModule[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "writing-objectives", titleKey: "modules.2.sections.writingObjectives" },
      { id: "structure-objective", titleKey: "modules.2.sections.structureObjective", priority: "essential" },
      ...
      { id: "guided-exploration", titleKey: "modules.2.sections.guidedExploration" },
      { id: "simulation-practice", titleKey: "modules.2.sections.simulationPractice" },
      { id: "evaluation-skill-check", titleKey: "modules.2.sections.evaluationSkillCheck" },
      { id: "when-to-use-each", titleKey: "modules.2.sections.whenToUseEach" },
    ],
  },
  {
    id: "3",
    ...
    sections: [
      ...
      { id: "distributing-headsets", titleKey: "modules.3.sections.distributingHeadsets" },
      { id: "during-session", titleKey: "modules.3.sections.duringSession", priority: "essential" },
      { id: "rotation-groups", titleKey: "modules.3.sections.rotationGroups" },
      ...
      { id: "first-session-tips", titleKey: "modules.3.sections.firstSessionTips", priority: "essential" },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "minimum-space-positioning", titleKey: "modules.4.sections.minimumSpacePositioning" },
      { id: "supervision-boundaries", titleKey: "modules.4.sections.supervisionBoundaries", priority: "essential" },
      { id: "impacts-disorientation", titleKey: "modules.4.sections.impactsDisorientation" },
      { id: "motion-sickness-fatigue", titleKey: "modules.4.sections.motionSicknessFatigue", priority: "essential" },
      { id: "hygiene-care-equipment", titleKey: "modules.4.sections.hygieneCareEquipment" },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "pre-vr-briefing", titleKey: "modules.5.sections.preVrBriefing" },
      { id: "what-to-explain", titleKey: "modules.5.sections.whatToExplain" },
      ...
      { id: "what-to-assess", titleKey: "modules.5.sections.whatToAssess" },
    ],
  },
  {
    id: "6",
    ...
    sections: [
      ...
      { id: "casting-issues", titleKey: "modules.6.sections.castingIssues" },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "where-to-find-apps", titleKey: "modules.7.sections.whereToFindApps" },
      { id: "exploration-apps", titleKey: "modules.7.sections.explorationApps" },
      { id: "simulation-apps", titleKey: "modules.7.sections.simulationApps" },
      ...
      { id: "integrating-apps-in-class", titleKey: "modules.7.sections.integratingAppsInClass" },
      { id: "tutorial-template", titleKey: "modules.7.sections.tutorialTemplate" },
      { id: "common-mistakes-apps", titleKey: "modules.7.sections.commonMistakesApps", priority: "essential" },
    ],
  },
];
