/**
 * Module 4 section content (English). Markdown strings keyed by section id.
 * "Safety, Wellbeing, and Accessibility in VR"
 */
export const sectionsEn: Record<string, string> = {
  "physical-safety-wellbeing": `The goal of physical safety planning is to **prevent accidents and discomfort** before they happen. A clear set of rules, communicated before anyone puts on a headset, is the foundation.
...
> "Safety in VR is not about fear — it is about preparation. A few clear rules prevent nearly every incident."`,
  ...
  "minimum-space-positioning": `The amount of physical space you allocate determines which VR activities are possible and how safe they will be. More space means better tracking accuracy and fewer collisions.
...
[IMAGE:vr-student-safety]`,
  ...
  "impacts-disorientation": `Some students may feel disoriented, dizzy, or unsteady during or after a VR session. Knowing the correct response steps ensures you handle the situation calmly and safely.
...
> "Sixty seconds of cleaning between users saves hours of maintenance later."`,
  ...
  "accessibility-inclusive-practices": `Accessibility in VR does not mean forcing identical experiences on every student. It means ensuring every student can participate meaningfully, with or without a headset.
...
> "Accessibility is about offering meaningful alternatives, not identical experiences."`,
  ...
  "students-may-not-use-vr": `There are many valid reasons why a student may not be able to — or may choose not to — use a VR headset. Knowing these reasons helps you plan inclusive sessions from the start.
...
Participation is always voluntary. A student who declines VR is not refusing to learn — they are communicating a boundary. Respect it without question and provide an alternative immediately.`,
  ...
  "inclusive-alternatives": `When a student cannot or chooses not to use VR, three practical alternatives ensure they still engage with the learning objective.
...
Each option should feel like a legitimate path, not a consolation prize.`,
  ...
  "observer-role": `The **Active Observer Role** is not a lesser experience — it is a different and equally valuable way to learn from a VR session.
